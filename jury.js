...
// /////////////////FONCTIONS////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        console.log(inputs);
        /////////////////////////////DECLARATION DE VAR LOCALE///////////////////////////////////////////////////////////
        var notes = [inputs[0].value, inputs[1].value, inputs[2].value]; //////////TABLEAU AFFECTE A NOTES////////////////
        console.log(notes);
        ///////////////////////////////////////////////ENTREE DANS BOUCLE POUR
        for (i = 0; i <= notes.length; i ++) //////////de i = 0 TANT QUE i <= la longueur de la variable notes avec un pas de 1////////////////////
        {
            //////////////////////////SI LA VALEUR DE L EMPLACEMENT DE I SUR NOTES EST SUPERIEURE A NOTEMAX////////////////
            if (notes[i] > noteMax)
                {
                    ///////////////////////////J EFFECTUE LES INSTRUCTIONS SUIVANTES///////////////////////////////
                    noteMax = notes[i]; //////////////////////J AFFECTE LA VALEUR DE LA POSITION DE I SUR NOTES A NOTEMAX//// 
                    if (notes[i] == notes[0]) ////////////SI LA POSITION DE I EST 0///////////////////////////////////////
                    {
                        winner = "l'art de l'ecriture"; ///////////////J AFFECTE A WINNER LA VALEUR DE "l'art de l'ecriture"///////
                    }
                    else
                        if (notes[i] == notes[1])////////////SI LA POSITION DE I EST 1///////////////////////////////////////
                        {
                            winner = "l'ennui en lisant";///////////////J AFFECTE A WINNER LA VALEUR DE "l'ennui en lisant"///////
                        }
                        else
                        {
                            winner = "Les cris de la nuit"; /////////////////SINON J AFFECTE A WINNER LA VALEUR DE "les cris de la nuit"///////
                        }
                }
            
            
        }
        style1.innerHTML =  "Meilleur Style français " + winner + " avec une note de " + noteMax ; //////// j'ecris dans l'emplacement style1
    }
///////////////////////////////////////////////////////MEME PRINCIPE POUR CHAQUE FONCTION APPELLEE////////////////////////
    function update1()
    {
        console.log(inputs1);
